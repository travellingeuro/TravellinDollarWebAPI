...
{
    public class travellingdollarContext : DbContext
    {
        public travellingdollarContext()
        {
        }

        public travellingdollarContext(DbContextOptions<travellingdollarContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseMySql("server=travellingeurodb.mysql.database.azure.com;port=3306;user=travellingeuro@travellingeurodb;password=*******;database=tdwebapi;sslmode=preferred");
            }
        }
    ...
    {
        public static travellingdollarContext Create(string connectionString)
        {
            var optionsBuilder = new DbContextOptionsBuilder<travellingdollarContext>();
            optionsBuilder.UseMySql(connectionString);
            var travellingeuroContext = new travellingdollarContext(optionsBuilder.Options);
